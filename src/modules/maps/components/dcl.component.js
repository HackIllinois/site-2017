...
class DCL extends Component {
    ...
    render = () => (
        ...
        <div className={styles['maps-body-panel']}>
            <div id={styles.header1} onClick={this.display} className={styles['maps-body-panel-header-1']}>
                <h4 className={styles['maps-body-panel-title']}>Digital Computer Lab</h4>
            ...
            { this.state.showData ? <div id="content-1" className={styles['maps-body-panel-content']}>
                <br />
                <img src="src/assets/img/svg/maps/dcl_firstfloor.svg" />
                <br />
            </div> : null }
        </div>
