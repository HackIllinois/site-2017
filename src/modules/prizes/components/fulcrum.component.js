    ...
    render = () => (
        ...
        <div className={styles['prizes-body-panel']}>
            <div id={styles.header1} onClick={this.display} className={styles['prizes-body-panel-header-1']}>
                <h4 className={styles['prizes-body-panel-title']}>Fulcrum</h4>
            ...
            { this.state.showData ? <div id="content-1" className={styles['prizes-body-panel-content']}>
                <br />
                <h5 className={styles['prizes-body-panel-content-title']}>One More Hour In The Day</h5>
                <h6 className={styles['prizes-body-panel-content-subtitle']}>
                    ...
                    <br /><br />
                    Presented by <a href="http://fulcrum-gt.com/">Fulcrum-GT</a>.
                </h6>
                <br />
            </div> : null }
        </div>
