...
class Reset extends Component {
	...
	render = () => (
		<div>
			...
			<div className={styles['form-container']}>
				<div className={styles['reg-input']}>
					<input onChange={this.onChangePass1} value={this.props.resetStore.createPassword} placeholder='Create new password' className={styles['top-component']} />
					<input onChange={this.onChangePass2} value={this.props.resetStore.confirmPassword} placeholder='Confirm new password' />
				</div>
